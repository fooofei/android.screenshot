...
import gdg.ninja.croplib.ICropViewListener;
...
/**
 * 2014.07.20  fix left right top bottom  bugs at adjustRectangle() 
 * @author hujianfei
 *
 */
public class CropView extends ImageView{
	...
	private ICropViewListener 	mICropViewListener;
	 ...
	 * @param listener
	 */
	public void setOnCropViewListener(ICropViewListener listener){
		mICropViewListener = listener;
	}
	...
	public boolean onTouchEvent(MotionEvent event){
		...
		switch(eventAction){
			...
			case MotionEvent.ACTION_MOVE:
				...
				// hujianfei
				if (null !=mICropViewListener) {
					mICropViewListener.onPressDown();
				}
